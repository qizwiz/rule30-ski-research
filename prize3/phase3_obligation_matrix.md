...
| O2 | Rule 30 indistinguishability witness discharging `h_witness` | Open | `prize3/lean/Prize3Model.lean` (interface + adapters) | Highest-risk technical gap remains: adapter lemmas exist, but concrete witness-construction proofs are still missing. |
