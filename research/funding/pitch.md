...
- **Proved:** Prize3 model/statement freeze, foundational dependency-width lemmas, conditional no-skip bridge scaffold, and required-interval boundary lemmas in `prize3/`.
