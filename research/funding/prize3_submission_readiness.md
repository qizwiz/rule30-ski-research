...
- Proved (in-repo):
  ...
  - Conditional no-skip scaffold (`must_observe_required`) plus boundary-witness adapter lemmas (`must_observe_required_of_le_two_mul_witness`, `must_observe_required_next_gen_of_le_two_mul_witness`) and support lemmas including `observes_self_of_exact` and `observes_two_mul_of_exact`
