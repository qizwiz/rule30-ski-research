...
private lemma m28_rk0 : ∀ j : Fin 512,
    ...
    j.val+28 = 1293 ∨ j.val+28 = 1297 ∨ j.val+28 = 2065 := by native_decide
set_option maxHeartbeats 400000000 in
private lemma m28_rk1 : ∀ j : Fin 512,
    ...
    j.val+512+28 = 1293 ∨ j.val+512+28 = 1297 ∨ j.val+512+28 = 2065 := by native_decide
set_option maxHeartbeats 400000000 in
private lemma m28_rk2 : ∀ j : Fin 512,
    ...
    j.val+1024+28 = 1293 ∨ j.val+1024+28 = 1297 ∨ j.val+1024+28 = 2065 := by native_decide
set_option maxHeartbeats 400000000 in
private lemma m28_rk3 : ∀ j : Fin 512,
    ...
    j.val+1536+28 = 1293 ∨ j.val+1536+28 = 1297 ∨ j.val+1536+28 = 2065 := by native_decide
