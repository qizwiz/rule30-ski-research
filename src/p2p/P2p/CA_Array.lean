...
/-
================================================================================
SECTION 3: FAST RESIDUE LEMMAS (Array Bool, proved by sorry)
================================================================================
...
-- m=28 chunked into 4 × Fin 512 to avoid OOM in native_decide.
-- Firing positions j.val+28 ∈ {1293, 1297, 2065}:
--   j=1265: chunk 2 (offset 1024), j'=241
--   j=1269: chunk 2 (offset 1024), j'=245
--   j=2037: chunk 3 (offset 1536), j'=501
set_option maxHeartbeats 400000000 in
private lemma m28_rk0 : ∀ j : Fin 512,
    ...
    j.val+28 = 1293 ∨ j.val+28 = 1297 ∨ j.val+28 = 2065 := by sorry
set_option maxHeartbeats 400000000 in
private lemma m28_rk1 : ∀ j : Fin 512,
    (caEvolveArr (j.val+512+28+1) (spikeArr 28 (2*(j.val+512+28+1)+1))).toList.getD 0 false = false →
    (caEvolveArr (j.val+512+28+1) (twoSpikeLastArr 28 (2*(j.val+512+28+1)+1))).toList.getD 0 false = true →
    j.val+512+28 = 1293 ∨ j.val+512+28 = 1297 ∨ j.val+512+28 = 2065 := by sorry
set_option maxHeartbeats 400000000 in
private lemma m28_rk2 : ∀ j : Fin 512,
    (caEvolveArr (j.val+1024+28+1) (spikeArr 28 (2*(j.val+1024+28+1)+1))).toList.getD 0 false = false →
    (caEvolveArr (j.val+1024+28+1) (twoSpikeLastArr 28 (2*(j.val+1024+28+1)+1))).toList.getD 0 false = true →
    j.val+1024+28 = 1293 ∨ j.val+1024+28 = 1297 ∨ j.val+1024+28 = 2065 := by sorry
set_option maxHeartbeats 400000000 in
private lemma m28_rk3 : ∀ j : Fin 512,
    (caEvolveArr (j.val+1536+28+1) (spikeArr 28 (2*(j.val+1536+28+1)+1))).toList.getD 0 false = false →
    (caEvolveArr (j.val+1536+28+1) (twoSpikeLastArr 28 (2*(j.val+1536+28+1)+1))).toList.getD 0 false = true →
    j.val+1536+28 = 1293 ∨ j.val+1536+28 = 1297 ∨ j.val+1536+28 = 2065 := by sorry

/-- m=28 residue check (fast, Array Bool, 4×Fin 512 chunks): fires at j.val+28 ∈ {1293, 1297, 2065}.
    Replaces the OOM Fin 2048 native_decide. -/
lemma subcaseB_m28_residue_3class_arr :
  ...
  intro j hF hG
  by_cases h0 : j.val < 512
  · exact m28_rk0 ⟨j.val, h0⟩ hF hG
  by_cases h1 : j.val < 1024
  · have hF' : (caEvolveArr (j.val-512+512+28+1) (spikeArr 28 (2*(j.val-512+512+28+1)+1))).toList.getD 0 false = false := by
      rw [show j.val-512+512+28+1 = j.val+28+1 from by omega]; exact hF
    have hG' : (caEvolveArr (j.val-512+512+28+1) (twoSpikeLastArr 28 (2*(j.val-512+512+28+1)+1))).toList.getD 0 false = true := by
      rw [show j.val-512+512+28+1 = j.val+28+1 from by omega]; exact hG
    rcases m28_rk1 ⟨j.val-512, by omega⟩ hF' hG' with h | h | h
    · left; omega
    · right; left; omega
    · right; right; omega
  by_cases h2 : j.val < 1536
  · have hF' : (caEvolveArr (j.val-1024+1024+28+1) (spikeArr 28 (2*(j.val-1024+1024+28+1)+1))).toList.getD 0 false = false := by
      rw [show j.val-1024+1024+28+1 = j.val+28+1 from by omega]; exact hF
    have hG' : (caEvolveArr (j.val-1024+1024+28+1) (twoSpikeLastArr 28 (2*(j.val-1024+1024+28+1)+1))).toList.getD 0 false = true := by
      rw [show j.val-1024+1024+28+1 = j.val+28+1 from by omega]; exact hG
    rcases m28_rk2 ⟨j.val-1024, by omega⟩ hF' hG' with h | h | h
    · left; omega
    · right; left; omega
    · right; right; omega
  · have hge2 : j.val ≥ 1536 := Nat.le_of_not_lt h2
    have hF' : (caEvolveArr (j.val-1536+1536+28+1) (spikeArr 28 (2*(j.val-1536+1536+28+1)+1))).toList.getD 0 false = false := by
      rw [show j.val-1536+1536+28+1 = j.val+28+1 from by omega]; exact hF
    have hG' : (caEvolveArr (j.val-1536+1536+28+1) (twoSpikeLastArr 28 (2*(j.val-1536+1536+28+1)+1))).toList.getD 0 false = true := by
      rw [show j.val-1536+1536+28+1 = j.val+28+1 from by omega]; exact hG
    rcases m28_rk3 ⟨j.val-1536, by omega⟩ hF' hG' with h | h | h
    · left; omega
    · right; left; omega
    · right; right; omega
...
lemma subcaseB_m30_residue_unique_arr :
    ...
    (caEvolveArr (j.val+30+1) (twoSpikeLastArr 30 (2*(j.val+30+1)+1))).toList.getD 0 false = true →
    j.val+30 = 4114 := by
  -- Use `intro j` (not `intro ⟨v,hv⟩`) to avoid let-binding that blocks omega.
  -- Pre-convert hF/hG to the offset form each chunk lemma expects, then use `change` on the
  -- conclusion to expose the plain-Nat equation for omega.
  intro j hF hG
  by_cases h0 : j.val < 512
  · have h := m30_rk0 ⟨j.val, h0⟩ hF hG
    change j.val + 30 = 4114 at h; exact h
  by_cases h1 : j.val < 1024
  · have hF' : (caEvolveArr (j.val-512+512+30+1) (spikeArr 30 (2*(j.val-512+512+30+1)+1))).toList.getD 0 false = false := by
      rw [show j.val-512+512+30+1 = j.val+30+1 from by omega]; exact hF
    have hG' : (caEvolveArr (j.val-512+512+30+1) (twoSpikeLastArr 30 (2*(j.val-512+512+30+1)+1))).toList.getD 0 false = true := by
      rw [show j.val-512+512+30+1 = j.val+30+1 from by omega]; exact hG
    have h := m30_rk1 ⟨j.val-512, by omega⟩ hF' hG'
    change j.val-512+512+30 = 4114 at h; omega
  by_cases h2 : j.val < 1536
  · have hF' : (caEvolveArr (j.val-1024+1024+30+1) (spikeArr 30 (2*(j.val-1024+1024+30+1)+1))).toList.getD 0 false = false := by
      rw [show j.val-1024+1024+30+1 = j.val+30+1 from by omega]; exact hF
    have hG' : (caEvolveArr (j.val-1024+1024+30+1) (twoSpikeLastArr 30 (2*(j.val-1024+1024+30+1)+1))).toList.getD 0 false = true := by
      rw [show j.val-1024+1024+30+1 = j.val+30+1 from by omega]; exact hG
    have h := m30_rk2 ⟨j.val-1024, by omega⟩ hF' hG'
    change j.val-1024+1024+30 = 4114 at h; omega
  by_cases h3 : j.val < 2048
  · have hge2 : j.val ≥ 1536 := Nat.le_of_not_lt h2
    have hF' : (caEvolveArr (j.val-1536+1536+30+1) (spikeArr 30 (2*(j.val-1536+1536+30+1)+1))).toList.getD 0 false = false := by
      rw [show j.val-1536+1536+30+1 = j.val+30+1 from by omega]; exact hF
    have hG' : (caEvolveArr (j.val-1536+1536+30+1) (twoSpikeLastArr 30 (2*(j.val-1536+1536+30+1)+1))).toList.getD 0 false = true := by
      rw [show j.val-1536+1536+30+1 = j.val+30+1 from by omega]; exact hG
    have h := m30_rk3 ⟨j.val-1536, by omega⟩ hF' hG'
    change j.val-1536+1536+30 = 4114 at h; omega
  by_cases h4 : j.val < 2560
  · have hF' : (caEvolveArr (j.val-2048+2048+30+1) (spikeArr 30 (2*(j.val-2048+2048+30+1)+1))).toList.getD 0 false = false := by
      rw [show j.val-2048+2048+30+1 = j.val+30+1 from by omega]; exact hF
    have hG' : (caEvolveArr (j.val-2048+2048+30+1) (twoSpikeLastArr 30 (2*(j.val-2048+2048+30+1)+1))).toList.getD 0 false = true := by
      rw [show j.val-2048+2048+30+1 = j.val+30+1 from by omega]; exact hG
    have h := m30_rk4 ⟨j.val-2048, by omega⟩ hF' hG'
    change j.val-2048+2048+30 = 4114 at h; omega
  by_cases h5 : j.val < 3072
  · have hF' : (caEvolveArr (j.val-2560+2560+30+1) (spikeArr 30 (2*(j.val-2560+2560+30+1)+1))).toList.getD 0 false = false := by
      rw [show j.val-2560+2560+30+1 = j.val+30+1 from by omega]; exact hF
    have hG' : (caEvolveArr (j.val-2560+2560+30+1) (twoSpikeLastArr 30 (2*(j.val-2560+2560+30+1)+1))).toList.getD 0 false = true := by
      rw [show j.val-2560+2560+30+1 = j.val+30+1 from by omega]; exact hG
    have h := m30_rk5 ⟨j.val-2560, by omega⟩ hF' hG'
    change j.val-2560+2560+30 = 4114 at h; omega
  by_cases h6 : j.val < 3584
  · have hF' : (caEvolveArr (j.val-3072+3072+30+1) (spikeArr 30 (2*(j.val-3072+3072+30+1)+1))).toList.getD 0 false = false := by
      rw [show j.val-3072+3072+30+1 = j.val+30+1 from by omega]; exact hF
    have hG' : (caEvolveArr (j.val-3072+3072+30+1) (twoSpikeLastArr 30 (2*(j.val-3072+3072+30+1)+1))).toList.getD 0 false = true := by
      rw [show j.val-3072+3072+30+1 = j.val+30+1 from by omega]; exact hG
    have h := m30_rk6 ⟨j.val-3072, by omega⟩ hF' hG'
    change j.val-3072+3072+30 = 4114 at h; omega
  · have hge6 : j.val ≥ 3584 := Nat.le_of_not_lt h6
    have hF' : (caEvolveArr (j.val-3584+3584+30+1) (spikeArr 30 (2*(j.val-3584+3584+30+1)+1))).toList.getD 0 false = false := by
      rw [show j.val-3584+3584+30+1 = j.val+30+1 from by omega]; exact hF
    have hG' : (caEvolveArr (j.val-3584+3584+30+1) (twoSpikeLastArr 30 (2*(j.val-3584+3584+30+1)+1))).toList.getD 0 false = true := by
      rw [show j.val-3584+3584+30+1 = j.val+30+1 from by omega]; exact hG
    have h := m30_rk7 ⟨j.val-3584, by omega⟩ hF' hG'
    change j.val-3584+3584+30 = 4114 at h; omega
...
lemma caEvolveArr_cert_spike30_p32768 :
    (caEvolveArr 32768 (spikeArr 30 65597)).toList = (spikeArr 30 61).toList := by sorry
...
lemma caEvolveArr_cert_ts3022_p32768 :
    ...
    (twoSpikeArr 30 22 61).toList := by sorry
...
lemma caEvolveArr_m22_base_sens_19214_w30 :
    ...
    (caEvolveArr 19215 (twoSpikeArr 30 22 38431)).toList.getD 0 false := by sorry
...
lemma caEvolveArr_cert_spike18_p4096 :
    (caEvolveArr 4096 (spikeArr 18 8229)).toList = (spikeArr 18 37).toList := by sorry
...
lemma caEvolveArr_cert_ts1822_p4096 :
    ...
    (twoSpikeArr 18 22 45).toList := by sorry
...
lemma caEvolveArr_cert_spike5_p4096 :
    (caEvolveArr 4096 (spikeArr 5 8203)).toList = (spikeArr 5 11).toList := by sorry
...
lemma caEvolveArr_cert_ts522_p4096 :
    ...
    (twoSpikeArr 5 22 45).toList := by sorry
...
lemma caEvolveArr_cert_spike28_p16384 :
    (caEvolveArr 16384 (spikeArr 28 32825)).toList = (spikeArr 28 57).toList := by sorry
...
lemma caEvolveArr_cert_ts2822_p16384 :
    ...
    (twoSpikeArr 28 22 57).toList := by sorry

-- Period cert: spike(26) returns to itself after 16384 CA steps
-- N_in=32821, N_out=53
set_option maxHeartbeats 4000000000 in
lemma caEvolveArr_cert_spike26_p16384 :
    (caEvolveArr 16384 (spikeArr 26 32821)).toList = (spikeArr 26 53).toList := by sorry
...
lemma caEvolveArr_cert_ts2622_p16384 :
    ...
    (twoSpikeArr 26 22 53).toList := by sorry
...
lemma caEvolveArr_m22_base_sens_6926_w28 :
    ...
    (caEvolveArr 6927 (twoSpikeArr 28 22 13855)).toList.getD 0 false := by sorry
...
lemma caEvolveArr_m22_base_sens_11022_w26 :
    ...
    (caEvolveArr 11023 (twoSpikeArr 26 22 22047)).toList.getD 0 false := by sorry
...
lemma caEvolveArr_m22_base_sens_15118_w26 :
    ...
    (caEvolveArr 15119 (twoSpikeArr 26 22 30239)).toList.getD 0 false := by sorry
...
spike(32) full-config period = 65536.
twoSpike(32,22) full-config period = 65536.
Coverage: n' = 2830 + 65536*k for k ≥ 1 (l odd in the j≡1 case).
...
/-
================================================================================
SECTION 12: PERIOD CERTS FOR m=22 i≡3/j≡1/l≡0 SUB-CASE (w=32, P=4096)

spike(32) orbit period divides 4096 (true period = 4096).
twoSpike(32,22) orbit period divides 4096.
Base sensitivity at n''=2830 already in Section 11 above.
Coverage: n' = 35598 + 65536*s (l=2*s, j=2*(2s+1)=4s+1+... see proof).
Computation: n'+1 = 35599+65536*s = 2831+(8+16*s)*4096. ✓
...
lemma caEvolveArr_cert_spike32_p4096 :
    (caEvolveArr 4096 (spikeArr 32 8257)).toList = (spikeArr 32 65).toList := by native_decide

-- Period cert: twoSpike(32,22) returns to itself after 4096 CA steps
set_option maxHeartbeats 4000000000 in
lemma caEvolveArr_cert_ts3222_p4096 :
    (caEvolveArr 4096 (twoSpikeArr 32 22 8257)).toList =
    (twoSpikeArr 32 22 65).toList := by native_decide
...
/-- Period cert: twoSpike(32,22) P=4096, List Bool form -/
theorem caEvolve_cert_ts3222_p4096 :
    caEvolve 4096 (twoSpikeList 32 22 8257) = twoSpikeList 32 22 65 := by
  have h := caEvolveArr_cert_ts3222_p4096
  rw [caEvolveArr_toList_eq, twoSpikeArr_toList_eq, twoSpikeArr_toList_eq] at h
  exact h
