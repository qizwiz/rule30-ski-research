...
\textbf{5 total}: the axiom \texttt{subcaseB\_m4\_ge3087} (the algebraic case above),
the master axiom \texttt{subcaseB\_resolution\_ge3087} (which assembles all sub-cases
and will become a theorem once the m=4 axiom is closed), two native\_decide axioms
for $m=28$ and $m=30$ residue classifications in \texttt{CA\_Array.lean} (currently
compiling in \texttt{CA\_Array\_residues.lean}), and the
\texttt{subcaseB\_right\_mirror\_ge3087} which will follow from left-boundary symmetry.
