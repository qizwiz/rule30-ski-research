...
This leaves two candidate paths: (i)~path (i) covers $n' \equiv 2 \pmod{4}$
cases via the parity reduction above, while $n' \equiv 1 \pmod{4}$ cases
require either a further reduction to a \emph{small}-$m$ case (via the
lifting lemma's algebraic structure) or (ii)~explicit witnesses for the
